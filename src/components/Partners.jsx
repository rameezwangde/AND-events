    ...
    <section className="relative w-full bg-[#FBF9F6] pt-4 lg:pt-8 pb-10 lg:pb-16 overflow-hidden selection:bg-[#8A1C22] selection:text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full flex flex-col items-center justify-center">
          ...
          <div className="w-[110%] max-w-[1000px] h-[50px] md:h-[80px] bg-gradient-to-b from-[#980b0b] to-[#750808] rounded-[50%] mt-[-20px] md:mt-[-30px] relative z-10 shadow-[0_30px_60px_rgba(0,0,0,0.4)] flex items-start justify-center">
            {/* Edge reflection */}
