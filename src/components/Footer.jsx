      ...
      <div className="max-w-[1600px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="col-span-1 lg:col-span-5 flex flex-col pr-0 lg:pr-12">
            <a href="#" className="flex items-center justify-start w-[150px] lg:w-[180px] mb-8">
            ...
            <div className="flex flex-col gap-3 max-w-[400px]">
              ...
              <div className="flex w-full bg-white/5 rounded-full border border-white/10 overflow-hidden focus-within:border-white/40 transition-colors">
                ...
                />
                <button className="bg-[#930708] text-white px-6 font-sans text-[11px] uppercase tracking-[0.1em] font-bold hover:bg-white hover:text-[#930708] transition-colors">
                  Join
                </button>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social, idx) => (
              <a 
                key={idx} 
                href={social.href} 
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:bg-white hover:border-white hover:text-[#930708] transition-colors duration-300"
              >
