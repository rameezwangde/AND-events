...
export default function OurServices() {
  return (
    <section className="relative w-full bg-[#F8F3EE] overflow-hidden selection:bg-[#930708] selection:text-white pt-0 pb-8 lg:pt-0 lg:pb-8 px-6 lg:px-10 -mt-10">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col lg:flex-row items-start justify-center gap-16 lg:gap-16">
        ...
        <div className="w-full lg:w-[40%] flex flex-col lg:sticky lg:top-[120px]">
          ...
          <h2 className="font-serif text-[48px] md:text-[64px] leading-[1.05] tracking-tight mb-6">
            ...
            <span className="block text-[#930708]">Celebrating Together.</span>
          </h2>

          {/* Brush stroke SVG */}
          <div className="w-[140px] h-[12px] mb-10 text-[#930708] opacity-80">
        ...
        <div className="w-full lg:w-[45%] lg:pr-10 relative lg:pt-[80px]">
          ...
          {/* Decorative Doodles */}
          <svg className="absolute top-[20%] left-[-5%] w-[80px] h-[80px] text-[#930708] opacity-30 -rotate-12 hidden xl:block" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M10,90 Q50,10 90,90 M80,70 L90,90 L70,90" />
          </svg>
          <svg className="absolute bottom-[20%] right-[-5%] w-[100px] h-[100px] text-[#930708] opacity-20 hidden xl:block" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="50" cy="50" r="40" strokeDasharray="4 4" />
          </svg>
          <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-[#930708] rounded-full opacity-20 hidden xl:block"></div>
            ...
            {services.map((card, idx) => (
              ...
              >
                ...
                <div className="relative mb-6 shrink-0">
                  ...
                  {/* Floating Icon */}
                  <div className="absolute bottom-[-16px] left-1/2 -translate-x-1/2 w-10 h-10 bg-[#930708] rounded-full flex items-center justify-center border-[3px] border-[#FFFDF9] shadow-lg group-hover:-translate-y-2 group-hover:scale-110 transition-transform duration-400 z-30">
