  ...
  return (
    <section className="relative w-full py-24 lg:py-32 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        >
          <span className="font-sans text-[11px] lg:text-xs uppercase tracking-[0.2em] font-medium mb-6 text-white/80">
            Ready to collaborate?
          </span>
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-8 leading-tight tracking-tight text-white">
            Let&apos;s Create Something <br className="hidden md:block" />
            <span className="italic font-light text-white">Extraordinary</span>
          </h2>
          <p className="font-sans text-sm md:text-base max-w-xl mx-auto mb-12 text-white/80 leading-relaxed">
